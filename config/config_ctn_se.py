...
class Config(object):
    log = './log_ctn_multi_v5'  # Path to save log
    checkpoint_path = './checkpoints_multi_v5'  # Path to store checkpoint model
    resume = './checkpoints_multi_v5/latest.pth'  # load checkpoint model
